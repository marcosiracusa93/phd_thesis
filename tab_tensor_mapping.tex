\begin{sidewaystable}
    ...
    \caption[Mapping different sparse tensor algebra kernels to TMU hardware.]{Mapping different sparse tensor algebra kernels to TMU hardware. Notation P\textit{x} means the loop at level \textit{x} is parallel.}
    \label{tab:tensor-mapping}
    %\vspace{-0.3cm}
    \resizebox{\textwidth}{!}{%
