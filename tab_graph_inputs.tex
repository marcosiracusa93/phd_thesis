\begin{table}
  \centering
  %\footnotesize
  \caption[Selected inputs for graph-learning models.]{Typical inputs for graph-learning models. Layer sizes indicates the size of the embedding vectors, defined as the number of elements. For GNNs, we report the embedding size of each layer.}
  \vspace{-1em}
\[
