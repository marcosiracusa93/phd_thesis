...
Motivated by this potential, hyperscalers have begun adopting DAE-like designs to accelerate irregular memory accesses in recommendation models~\cite{tpu2023isca,mtia2023isca}. Prior work has similarly shown that DAE architectures can accelerate irregular memory accesses in scientific workloads~\cite{spzip2021isca,maple2022isca,planar2021acm}. However, these architectures and their associated programming models primarily target a limited set of irregular access patterns. Consequently, although prior work demonstrates the promise of DAE architectures for selected sparse tensor operations, no existing DAE architecture accelerates general sparse tensor algebra, at no programmability cost. This thesis closes this gap.
