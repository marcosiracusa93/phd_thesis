\begin{table}[]
    \centering
    %\footnotesize
    \caption[Specifications of the multicore CPU processor used in our study (baseline).]{Specifications of the multicore CPU processor used in our study, a high-performance HPC processor with Arm-like cores, HBM, and large caches.}
    \vspace{-0.5em}
    \begin{tabular}{rl}
        \toprule
