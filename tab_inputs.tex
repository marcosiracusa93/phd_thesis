\begin{table}
\centering
\caption[Selected inputs for scientific models.]{Inputs for the sparse tensor algebra kernels in scientific models.}
\label{tab:inputs} 
\resizebox{\columnwidth}{!}{%
\begin{tabular}{@{}cccccc@{}}
\toprule
\textbf{Id} & \textbf{Matrix~\cite{suitesparse2011acm}} & \textbf{nnzs} & \textbf{rows} & \textbf{nnzs/row} & \textbf{Domain}\\
\midrule
...
\hline
\textbf{Id} & \textbf{Tensor~\cite{frosttdataset}} & \textbf{nnzs} & \multicolumn{2}{c}{\textbf{Dimensions}} & \textbf{Domain} \\
\hline
