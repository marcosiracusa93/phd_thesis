...
\vspace{-0.5em}
\caption[Performance of Ember generated code.]{DAE code automatically generated and optimized by Ember (\texttt{emb-opt3}) achieves a geomean 99\% performance compared to hand-optimized code (\texttt{ref-dae}) across the different model classes in \Cref{sec:embedding-workload-characterization}.}
