\begin{table}
\centering
\caption[Specifications of the simulated DAE multicore processor.]{Specifications of the simulated DAE multicore processor composed of HBM and Arm-like beefy HPC cores, each one featuring a TMU.}
%\vspace{-0.3cm}
