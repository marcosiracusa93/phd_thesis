...
This chapter summarizes the contributions of this thesis, and its impact in the research community, including papers and patents, awards, spinoff projects, and collaborations.
...
\begin{itemize}
\item Xicu Mari’s Master Thesis, which proposes the first RTL implementation and integration of a Tensor Marshaling Unit (TMU) in a System on Chip. The obtained results demonstrated the feasibility of the TMU in a real SoC and established the first milestone of a larger effort towards enabling the TMU in production systems.
\item A collaboration between the Barcelona Supercomputing Center and UC Santa Barbara to integrate the TMU into an OpenPiton-based SoC with the CVA6 RISC-V core, and suggest optimizations for the OpenPiton framework.
\item Diego Gorfini’s Master Thesis, which optimizes the integration of the TMU in BSC cores.
\end{itemize}
