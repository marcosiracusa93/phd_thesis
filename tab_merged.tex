...
\label{tab:tmu-isa-traversal-primitives}
\resizebox{\textwidth}{!}{%
\begin{tabular}{@{}llll@{}}
\toprule
...
\label{tab:tmu-isa-data-streams}
\begin{tabular}{@{}llc@{}}
\toprule
...
\texttt{map} & selects \texttt{x}-th value from a small TU-local map \texttt{a=\{v1,...,v16\}} & \texttt{a[x]}\\
...
\midrule
\texttt{DisjMrg} & joins lanes in the current TMU layer\\
\texttt{ConjMrg} & intersects lanes in the current TMU layer\\
\texttt{LockStep} & co-iterates lanes in the current TMU layer\\
\bottomrule
\end{tabular}
