...
This section outlines several promising directions for future research:
\begin{itemize}
    ...
    \item Another direction on the architectural side is to optimize the TMU ISA and microarchitecture to also accelerate dense tensor algebra, similar in spirit to NVIDIA’s Tensor Memory Accelerators (TMAs). This would enable unified and efficient support for both sparse and dense tensor workloads within a single system.
