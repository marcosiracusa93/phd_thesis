\begin{table}[]
    ...
    \begin{tabular}{clccccc}
        ...
        \toprule
            ...
            \normalsize$\frac{2}{1}$ &
            \makecell{GBs} &
            \vcentered{\includegraphics[width=.3\linewidth]{img_cdf_gnn.pdf}} &
            8-349\\ 
        \hline
            ...
            \makecell{GBs} &
            \vcentered{\includegraphics[width=.3\linewidth]{img_cdf_mp.pdf}} &
            128\\
        \hline
            ...
            \normalsize$\frac{4}{3}$ &
            \makecell{GBs} &
            \vcentered{\includegraphics[width=.3\linewidth]{img_cdf_kg.pdf}} &
            512\\
        \hline
            ...
            \normalsize$\frac{1}{1}$ &
            \makecell{TBs} &
            \vcentered{\includegraphics[width=.3\linewidth]{img_cdf_dlrm.pdf}} &
            32-256\\
        \hline
            ...
            \normalsize$0$ &
            \makecell{MBs-GBs} &
            \vcentered{\includegraphics[width=.3\linewidth]{img_cdf_llm.pdf}} &
            $\leq$ 8x8x512\\
        \bottomrule
    \end{tabular}
    }
    \label{tab:embedding-workload-characterization-combined}
\end{table}
