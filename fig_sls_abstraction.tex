\begin{figure}
    ...
    \begin{subfigure}{0.8\columnwidth}
        ...
        \label{fig:ember-eb-functional-example}
    \end{subfigure}
...
void eb(idxs, ptrs, vals, out){
  for(int b = 0; b < num_batches; b++){ // Batch traversal (b_tr)
    ...
    \label{fig:ember-eb-imperative-code}
    \end{minipage}
 ...
 callback(e_tr, ite) //trigger call on every emb iter
    ...
    \label{fig:ember-dlc-lookup-code}
    \end{minipage}
    ...
    \begin{subfigure}{\columnwidth}
        ...
        \label{fig:ember-dlc-queue-content}
    \end{subfigure}
...
while(ctrlQ.pop() == (*$e_i$*)){ // while some element
  ...
  fma(&out[b,e],v); // compute and store
    ...
    \label{fig:ember-dlc-compute-code}
    \end{minipage}
    ...
    \label{fig:ember-dlc-eb-representation}
\end{figure}
